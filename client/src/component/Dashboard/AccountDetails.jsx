...
export default function AccountDetails() {
  ...
  //console.log("TOTAL ===", typeof account?.data?.initialBalance);

  return (
    <>
      {account?.data?.transactions.length <= 0 ? (
        <>
          <h1 className="text-red-500 text-2xl flex justify-center mb-10 mt-2">This account does not have any transactions</h1>
        ...
        <>
          ...
          <AllTransactions transactions={account?.data?.transactions} accountID={accountID} />
        </>
      )}
    </>
  );
